    ...
    <div class="container">
      <div class="Prices__inner">
        ...
        <div class="Prices__subtitle">
          Главные аргументы для долгосрочного сотрудничества с нами – это
          <br>
          профессионализм и эффективная работа всей команды EduPartner.
        </div>
        <br>
        <br>
        <br>
        <br>
        <div class="Prices__subtitle1">
          С уважением,
          <br>
          ваш бизнес-консультант Наталья Мещерякова
        </div>
      </div>
    </div>
  </section>
