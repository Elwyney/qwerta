...
export default {
  ...
  head () {
    return {
      title: 'Разработка сайтов по доступной цене в Уфе от компании EduPartner',
      meta: [
        {
          name: 'description',
          content: 'Заказать сайт по доступной цене в Уфе. Создадим лендинг(ladning page), корпоративный сайт, сайт для интернет-магазина, с индивидуальным дизайном или готовому решению. Команда высококлассных специалистов. Поможем вашему бизнесу расти и развиваться! ⭐Бесплатная консультация. Звоните!☎ +7 (347) 214-51-29'
        }
      ]
    }
  },
