...
<script>
// import AppSpace from '~/components/MainPage/AppSpace.vue'
// import AppDirections from '~/components/MainPage/AppDirections.vue'
import AppDirectionsNew from '~/components/MainPage/AppDirectionsNew.vue'
...
export default {
  name: 'IndexPage',
  components: { AppDirectionsNew, AppAbout, AppProgress, AppControl, AppChoose, AppProjects },
  head () {
    return {
